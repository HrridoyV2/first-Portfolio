...
const Skill = () => {
    ...
    const allSkill = [
      ...
      { id: "02", skillType: "web", skill: "Redux", expertLevel: 60 },
      ...
      { id: "06", skillType: "web", skill: "React-Native", expertLevel: 80 },
      ...
      { id: "20", skillType: "tools", skill: "Photoshop", expertLevel: 45 },
      { id: "21", skillType: "tools", skill: "Illustrator", expertLevel: 30 },
    ];
